...
class Actor extends AdvancedBase {
     ...
     * 
     * @param {Function} type - The actor type constructor to instantiate.
     * @param {Object} params - Parameters for the actor type.
     * @param {string} [params.user_uid] - User UUID to resolve to user object.
     * @param {string} [params.app_uid] - App UID to resolve to app object.
     * @returns {Promise<Actor>} A new Actor instance with the specified type.
     */
    ...
    /**
     * Gets the unique identifier for this actor from its type.
     * 
     * @returns {string} The actor's unique identifier.
     */
    get uid () {
     ...
     * Includes the UID and username if the actor has an associated user.
     * 
     * @returns {Object} Object containing logging fields for this actor.
     */
    toLogFields () {
        return {
            uid: this.type.uid,
     ...
     * 
     * @param {Function} type_class - The actor type class to create a related actor for.
...
class ActorType {
    /**
     * Creates a new ActorType instance.
     * 
...
class SystemActorType extends ActorType {
     ...
     * 
     * @returns {string} The system actor UID.
     */
    get uid () {
        return 'system';
    }
    ...
    /**
     * Gets a related actor type based on the provided type class.
     * 
     * @param {Function} type_class - The actor type class to get a related type for.
     * @returns {ActorType} The related actor type instance.
     * @throws {Error} If the requested type cannot be obtained from this actor type.
     */
...
class UserActorType extends ActorType {
     ...
     * 
     * @returns {string} The user actor UID in the format 'user:{uuid}'.
     */
    get uid () {
...
class AppUnderUserActorType extends ActorType {
     ...
     * 
     * @returns {string} The app-under-user actor UID in the format 'app-under-user:{user_uuid}:{app_uid}'.
     */
    get uid () {
...
class AccessTokenActorType extends ActorType {
     ...
     * This would be dangerous because of ambiguity between authorizer and authorized actors.
     * 
...
class SiteActorType {
     ...
     * 
     * @returns {string} The site actor UID in the format 'site:{site_name}'.
     */
    get uid () {
 ...
 * Handles legacy cases where a user object is passed instead of an actor.
 * 
